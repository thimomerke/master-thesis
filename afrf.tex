...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{Global Afforestation marginal removal cost curve - forest plantation}
    \label{fig:forest_cycle}
  \end{center}
  \vspace*{-\baselineskip}
\end{figure}
